...
(() => {
  ...
  const exact = new Map([
    ...
    ["練習", "Practice"], ["通し練習", "Full Run"], ["パート練習", "Section Practice"],
    ...
    ["スタート後、該当する場所をタップ", "After starting, tap the relevant step"],
    ["失敗・実施できなかった場所をタップ", "Tap a failed or unattempted step"],
