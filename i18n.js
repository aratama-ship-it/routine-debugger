...
(() => {
  ...
  const exact = new Map([
    ...
    ["撮影画角", "Camera framing"], ["3:4 広め", "3:4 Wide"], ["9:16 縦長", "9:16 Tall"],
    ...
    ["音源の停止に合わせて終了しました。通し結果を記録すると保存確認へ進みます。", "Recording ended with the music. Log the run result to continue to the save confirmation."],
