...
const APP_VERSION = "v55"; // 要望フォーム等で自動送信するアプリ版
    ...
    <div class="editor-step">
      ...
      <div class="es-row2">
        ...
        ${isSlot(s)
          ...
          : (showSlots ? `<button class="kind-toggle" onclick="toggleSlot(${i})">A/B化</button>` : "")}
        ...
        ${showRisk && !isSlot(s) ? riskSelect(s.risk ?? null, `setRisk(${i},this.value)`) : ""}
