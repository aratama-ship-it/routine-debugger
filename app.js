...
const APP_VERSION = "v38"; // 要望フォーム等で自動送信するアプリ版
...
const THEMES = [
  ...
  { key: "wa", name: "和", swatch: ["#14110d", "#211c15", "#d8492f"] },
    ...
    <div class="card">
      ...
      ${draft._newMusicFile || draft.music
        ...
        : `<div class="row-2">
             ...
             <button class="btn small ghost" onclick="sheetSampleMusic('edit')">♪ サンプル曲から</button>
           </div>`}
  ...
  return `
    ...
    <div class="card music-card">
      ...
      : `<div class="row-2">
           ...
           <button class="btn small ghost" onclick="sheetSampleMusic('builder')">♪ サンプル曲から</button>
         </div>`}
