...
// +約6KB(212KBへ)。同日P2(深部機能約105項目)でさらに+約2KB(218KBへ)。
// いずれも翻訳データの重さ。コード側で次に当たったら、まず減らすこと。
if (gzipShell > 218_000) failures.push(`主要コードのgzip概算が218KBを超えています (${gzipShell})`);
