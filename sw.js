...
const CACHE = "routine-debugger-v217";
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=217",
  "./batch-sequence-import.css?v=217",
  "./tablet.css?v=217",
  "./i18n.js?v=217",
  "./run-video-orientation.js?v=217",
  "./run-video-composition.js?v=217",
  "./run-video-sync.js?v=217",
  "./run-video-review.js?v=217",
  "./music-playback.js?v=217",
  "./batch-sequence-import.js?v=217",
  "./app.js?v=217",
